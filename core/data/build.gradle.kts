...
android {
    namespace = "com.apexedits.core.data"
...
// Room's exported schemas are committed, so a future migration can be written
// and tested against the exact schema that shipped rather than a reconstruction.
